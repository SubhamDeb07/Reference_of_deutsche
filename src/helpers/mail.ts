...
const facebookUrl = 'https://www.facebook.com/deutschealigners';
const instagramUrl = 'https://www.instagram.com/deutschealigners';
const twitterUrl = 'https://twitter.com/deutschealigner';
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;" width="100%">
                        <tr>
                            <td class="align-left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; text-align: left;" valign="top" align="left">
                                <a href=${frontEndHost} style="color: #1A56DB; text-decoration: underline;"><img src="http://deutsche-preprod-assets.s3.ap-south-1.amazonaws.com/f0406e2585c24bc2b85dbd8f0dd48676.png" height="40" alt="Postdrop" style="border: none; -ms-interpolation-mode: bicubic; max-width: 100%;"></a>
                            </td>
                    ...
                    <table role="presentation" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; background: #ffffff; border-radius: 3px; width: 100%;" width="100%">
                        ...
                        <tr>
                            <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box;" valign="top">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;" width="100%">
                                    <tr>
                                        <img src="https://deutsche-preprod-assets.s3.ap-south-1.amazonaws.com/38e45750ca4a43bc857ce0e67a92d81a.png" style="border: none; -ms-interpolation-mode: bicubic; max-width: 100%;">
                                    </tr>
                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: auto; width: auto;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #1A56DB;" valign="top" align="center" bgcolor="#1A56DB"> <a href="${ctaLink}" target="_blank" style="border: solid 1px #1A56DB; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #1A56DB; border-color: #1A56DB; color: #ffffff;">${ctaText}</a> </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;" width="100%">
                            <tr>
                                <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #9a9ea6; font-size: 12px; text-align: center;" valign="top" align="center">
                                    This email was sent to <a href="mailto:" style="text-decoration: underline; color: #9a9ea6; font-size: 12px; text-align: center;">${to}</a>. If you'd rather
                                    not receive this kind of email, you can <a href="${frontEndHost}" style="text-decoration: underline; color: #9a9ea6; font-size: 12px; text-align: center;">unsubscribe</a> or <a style="text-decoration: underline; color: #9a9ea6; font-size: 12px; text-align: center;">manage your email
                                        preferences</a>.
                                </td>
                            </tr>
                            <tr>
                                <td class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #9a9ea6; font-size: 12px; text-align: center;" valign="top" align="center">
                                    Copyright © 2022 Deutsche Aligners.
                                </td>
                            </tr>
                        </table>
                    </div>
...
export async function setPasswordMail(
	params: PasswordResetEmailParams,
	name: string,
	clinicName: string | '',
	labName: string | '',
	type: 'forget' | 'invitation',
	role: RoleCode,
	...
	if (type === 'forget') {
		const resetLink = `${frontEndHost}/invite/setpassword?token=${params.token}`;

		bodyContent = `Hello ${name},<br/><br/>A request to reset your password has been made. If this was you, please follow the button below to complete the process:<br/><br/>If you did not initiate this request, please disregard this message. This password reset link is only valid for the next 30 minutes.<br/><br/>Best regards,<br/>Deutsche Aligner's team`;
		...
		const resetLink = `${frontEndHost}/login`;

		const getRoleMessage = (role: RoleCode) => {
			switch (role) {
				case RoleCode.DENTIST:
					return {
						subject: `Welcome to ${clinicName} - Activate Your Dentist Account`,
						message: `Dear ${name},<br/><br/>We're excited to inform you that your new dentist account at ${clinicName} is ready! Please create your password to activate your account and access our portal.<br/><br/>Welcome to the ${clinicName} family! <br><br>ID: ${params.recipientEmail}<br>Password: ${params.token}`,
					};
				case RoleCode.DENTIST_ADMIN:
					return {
						subject: ` Welcome to Deutsche Aligner - Activate Your Clinic Account`,
						message: `Dear ${name},<br/><br/>We're excited to inform you that your Clinic account on the Deutsche Aligner portal is now set up. To begin using the portal, please set up your password and activate your account.<br/><br/>Welcome to the Deutsche Aligner family! <br><br>ID: ${params.recipientEmail}<br>Password: ${params.token}`,
					};
				case RoleCode.TREATMENT_PLANNER:
					return {
						subject: `Welcome to ${labName} - Activate Your Treatment Planner Account`,
						message: `Dear ${name},<br/><br/>We're excited to inform you that your new Treatment Planner account at ${labName} is ready! Please create your password to activate your account and access our portal.<br/><br/>Welcome to the ${labName} family! <br><br>ID: ${params.recipientEmail}<br>Password: ${params.token}`,
					};
				case RoleCode.PRODUCTION_MANAGER:
					return {
						subject: `Welcome to ${labName} - Activate Your Production Manager Account`,
						message: `Dear ${name},<br/><br/>We're excited to inform you that your new Production Manager account at ${labName} is ready! Please create your password to activate your account and access our portal.<br/><br/>Welcome to the ${labName} family! <br><br>ID: ${params.recipientEmail}<br>Password: ${params.token}`,
					};
				case RoleCode.DELIVERY_COORDINATOR:
					return {
						subject: `Welcome to ${labName} - Activate Your Delivery Coordinator Account`,
						message: `Dear ${name},<br/><br/>We're excited to inform you that your new Delivery Coordinator account at ${labName} is ready! Please create your password to activate your account and access our portal.<br/><br/>Welcome to the ${labName} family!<br><br>ID: ${params.recipientEmail}<br>Password: ${params.token}`,
					};
				default:
					return {
						subject: `Welcome to Deutsche Aligner`,
						message: `Welcome to Deutsche Aligner...`,
					};
			}
		};

		const roleContent = getRoleMessage(role);
		bodyContent = `${roleContent.message}`;
		subject = roleContent.subject;
	...
	const emailParams: AWS.SES.SendEmailRequest = {
		...
		Message: {
			Body: {
				Html: {
					Charset: 'UTF-8',
					Data: emailTemplate(to, '', body, 'View Portal', frontEndHost),
				},
			},
			Subject: {
				Charset: 'UTF-8',
